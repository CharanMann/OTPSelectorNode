 ...
 */
public class OTPSelectorNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public OTPSelectorNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
